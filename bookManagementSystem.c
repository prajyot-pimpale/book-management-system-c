...
{
    arr[0].id=1;
    strcpy(arr[0].bookName,"The Guide");
    strcpy(arr[0].authorName,"R.K. Narayan");
    strcpy(arr[0].catagory,"fiction");
    arr[0].price=199;
    arr[0].rating=9.2;
    //
    arr[1].id=2;
    strcpy(arr[1].bookName,"Godan");
    strcpy(arr[1].authorName,"M. Premchand");
    strcpy(arr[1].catagory,"fiction");
    arr[1].price=150;
    arr[1].rating=8.9;
    //
    arr[2].id=3;
    strcpy(arr[2].bookName,"Malgudi Days");
    strcpy(arr[2].authorName,"R.K. Narayan");
    strcpy(arr[2].catagory,"fiction");
    arr[2].price=175;
    arr[2].rating=9.0;
    //
    arr[3].id=4;
    strcpy(arr[3].bookName,"The White Tiger");
    strcpy(arr[3].authorName,"Aravind Adiga");
    strcpy(arr[3].catagory,"drama");
    arr[3].price=299;
    arr[3].rating=8.7;
    //
    arr[4].id=5;
    strcpy(arr[4].bookName,"Train to Pakistan");
    strcpy(arr[4].authorName,"Khushwant Singh");
    strcpy(arr[4].catagory,"drama");
    arr[4].price=220;
    arr[4].rating=8.5;
    //
    arr[5].id=6;
    strcpy(arr[5].bookName,"Pinjar");
    strcpy(arr[5].authorName,"Amrita Pritam");
    strcpy(arr[5].catagory,"drama");
    arr[5].price=180;
    arr[5].rating=8.3;
    //
    arr[6].id=7;
    strcpy(arr[6].bookName,"The Rozabal Line");
    strcpy(arr[6].authorName,"Ashwin Sanghi");
    strcpy(arr[6].catagory,"suspense");
    arr[6].price=350;
    arr[6].rating=7.8;
    //
    arr[7].id=8;
    strcpy(arr[7].bookName,"Chanakyas Chant");
    strcpy(arr[7].authorName,"Ashwin Sanghi");
    strcpy(arr[7].catagory,"suspense");
    arr[7].price=320;
    arr[7].rating=8.1;
    //
    arr[8].id=9;
    strcpy(arr[8].bookName,"Sacred Games");
    strcpy(arr[8].authorName,"Vikram Chandra");
    strcpy(arr[8].catagory,"crime");
    arr[8].price=499;
    arr[8].rating=9.1;
    //
    arr[9].id=10;
    strcpy(arr[9].bookName,"Delhi Noir");
    strcpy(arr[9].authorName,"Hirsh Sawhney");
    strcpy(arr[9].catagory,"crime");
    arr[9].price=275;
    arr[9].rating=7.6;
}
